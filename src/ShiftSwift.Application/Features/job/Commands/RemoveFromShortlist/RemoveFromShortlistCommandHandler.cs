...
public sealed class RemoveFromShortlistCommandHandler(
    IUnitOfWork unitOfWork,
    ICurrentUserProvider currentUserProvider)
    : IRequestHandler<RemoveFromShortlistCommand, ErrorOr<ApiResponse<string>>>
{
    public async Task<ErrorOr<ApiResponse<string>>> Handle(RemoveFromShortlistCommand request, CancellationToken cancellationToken)
    {
        ...
        var jobApplication = await unitOfWork.JobApplications.Entites()
