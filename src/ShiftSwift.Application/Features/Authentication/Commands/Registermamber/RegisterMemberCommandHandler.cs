...
{
    public sealed class RegisterMemberCommandHandler : IRequestHandler<RegisterMemberCommand, ErrorOr<ApiResponse<RegisterationMemberResult>>>
    {
        ...
        public async Task<ErrorOr<ApiResponse<RegisterationMemberResult>>> Handle(RegisterMemberCommand request, CancellationToken cancellationToken)
        {
